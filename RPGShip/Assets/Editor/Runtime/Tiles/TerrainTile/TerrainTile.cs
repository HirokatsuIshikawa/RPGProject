...
namespace UnityEngine.Tilemaps
{
    ...
    public class TerrainTileEditor : Editor
    {
        ...
        protected int[] NoList = new int[] { 2, 4, 17, 19, 7, 16, 32, 24, 28, 40, 46, 44, 45, 33, 48 };
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("TileSpriteSet"))
            {
                ...
                if (spriteTex != null)
                {
                    ...
                    {
                        tile.m_Sprites[i] = getSprite(sprites, spriteName, NoList[i]);
                    }
                }
            }
            ...
            tile.m_Sprites[1] = (Sprite)EditorGUILayout.ObjectField("上空き", tile.m_Sprites[1], typeof(Sprite), false, null);
            tile.m_Sprites[2] = (Sprite)EditorGUILayout.ObjectField("上右空き", tile.m_Sprites[2], typeof(Sprite), false, null);
            tile.m_Sprites[3] = (Sprite)EditorGUILayout.ObjectField("左下壁", tile.m_Sprites[3], typeof(Sprite), false, null);
            tile.m_Sprites[4] = (Sprite)EditorGUILayout.ObjectField("左右壁", tile.m_Sprites[4], typeof(Sprite), false, null);
            tile.m_Sprites[5] = (Sprite)EditorGUILayout.ObjectField("左壁", tile.m_Sprites[5], typeof(Sprite), false, null);
            tile.m_Sprites[6] = (Sprite)EditorGUILayout.ObjectField("左壁斜め右上空き", tile.m_Sprites[6], typeof(Sprite), false, null);
            tile.m_Sprites[7] = (Sprite)EditorGUILayout.ObjectField("左壁斜め右下空き", tile.m_Sprites[7], typeof(Sprite), false, null);
            tile.m_Sprites[8] = (Sprite)EditorGUILayout.ObjectField("左壁右全空き", tile.m_Sprites[8], typeof(Sprite), false, null);
            tile.m_Sprites[9] = (Sprite)EditorGUILayout.ObjectField("四つ角", tile.m_Sprites[9], typeof(Sprite), false, null);
            tile.m_Sprites[10] = (Sprite)EditorGUILayout.ObjectField("三つ角右上空き", tile.m_Sprites[10], typeof(Sprite), false, null);
            tile.m_Sprites[11] = (Sprite)EditorGUILayout.ObjectField("左上左下角", tile.m_Sprites[11], typeof(Sprite), false, null);
            tile.m_Sprites[12] = (Sprite)EditorGUILayout.ObjectField("左上右下角", tile.m_Sprites[12], typeof(Sprite), false, null);
            tile.m_Sprites[13] = (Sprite)EditorGUILayout.ObjectField("左上角", tile.m_Sprites[13], typeof(Sprite), false, null);
            tile.m_Sprites[14] = (Sprite)EditorGUILayout.ObjectField("全空き", tile.m_Sprites[14], typeof(Sprite), false, null);
